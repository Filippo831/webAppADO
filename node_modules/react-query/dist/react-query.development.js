(function (global, factory) {
  ...
  var QueryCache = /*#__PURE__*/function (_Subscribable) {
    ...
    _proto.build = function build(client, options, state) {
      ...
      var queryHash = (_options$queryHash = options.queryHash) != null ? _options$queryHash : getQueryKeyHashFn(options)(queryKey);
  ...
  var QueryClient = /*#__PURE__*/function () {
    ...
    _proto.defaultQueryOptions = function defaultQueryOptions(options) {
      ...
      if (!defaultedOptions.queryHash && defaultedOptions.queryKey) {
        defaultedOptions.queryHash = getQueryKeyHashFn(defaultedOptions)(defaultedOptions.queryKey);
      }
    ...
    _proto.notify = function notify(notifyOptions) {
      ...
      notifyManager.batch(function () {
        ...
        if (notifyOptions.onSuccess) {
          _this7.options.onSuccess == null ? void 0 : _this7.options.onSuccess(_this7.currentResult.data);
          _this7.options.onSettled == null ? void 0 : _this7.options.onSettled(_this7.currentResult.data, null);
        } else if (notifyOptions.onError) {
          _this7.options.onError == null ? void 0 : _this7.options.onError(_this7.currentResult.error);
          _this7.options.onSettled == null ? void 0 : _this7.options.onSettled(undefined, _this7.currentResult.error);
        } // Then trigger the listeners


        if (notifyOptions.listeners) {
          _this7.listeners.forEach(function (listener) {
            listener(_this7.currentResult);
          });
        } // Then the cache listeners


        if (notifyOptions.cache) {
          _this7.client.getQueryCache().notify(_this7.currentQuery);
        }
      });
    };
  ...
  function shouldFetchOptionally(query, prevQuery, options, prevOptions) {
    return (query !== prevQuery || options.enabled !== false && prevOptions.enabled === false) && isStale(query, options);
  }
  ...
  var QueriesObserver = /*#__PURE__*/function (_Subscribable) {
    ...
    _proto.getOptimisticResult = function getOptimisticResult(queries) {
      ...
      return queries.map(function (options, i) {
        ...
        if (!observer) {
          observer = new QueryObserver(_this3.client, defaultedOptions);
        }
    ...
    _proto.updateObservers = function updateObservers(notifyOptions) {
      ...
      notifyManager.batch(function () {
        ...
        var newObservers = _this4.queries.map(function (options, i) {
          ...
          return new QueryObserver(_this4.client, defaultedOptions);
        });
  ...
  function useBaseQuery(options, Observer) {
    ...
    if (obsRef.current.options.suspense && result.isLoading) {
      throw queryClient.fetchQuery(defaultedOptions).then(function (data) {
    ...
    if ((obsRef.current.options.suspense || obsRef.current.options.useErrorBoundary) && result.isError) {
      throw result.error;
